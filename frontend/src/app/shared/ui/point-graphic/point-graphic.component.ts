...
public lineChartType: ChartType = 'line';
  ...
  @Input() lineColor: string = '#7C3AED';
  @Input() fillFrom: string = 'rgba(124, 58, 237, 0.4)';
  @Input() fillMid: string = 'rgba(124, 58, 237, 0.2)';
  @Input() fillTo: string = 'rgba(124, 58, 237, 0.05)';
